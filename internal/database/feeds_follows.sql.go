...
const deleteAllFeddFollows = `-- name: DeleteAllFeddFollows :exec
DELETE FROM feed_follows
`

func (q *Queries) DeleteAllFeddFollows(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, deleteAllFeddFollows)
	return err
}
